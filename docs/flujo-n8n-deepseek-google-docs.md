...
Recibir datos del formulario de derecho de petición, mejorar la redacción con DeepSeek, crear un documento editable, registrar el seguimiento y enviar una alerta no sensible.
...
- No subir `.env`.
- No pegar API Keys en el código.
