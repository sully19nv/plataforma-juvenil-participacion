  ...
  try {
    ...
    if (!response.ok) {
      resultado.textContent =
        data.mensaje || "Ocurrió un error al generar la petición.";
      return;
    }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    .addEventListener("click", mostrarVistaPrevia);

  document
    .getElementById("btnCopiar")
    .addEventListener("click", copiarBorrador);

  document
    .getElementById("formPeticion")
    .addEventListener("submit", enviarAlBackend);
});